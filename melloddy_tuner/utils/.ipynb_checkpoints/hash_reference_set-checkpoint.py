...
def main(args: dict = None):
    ...
    if ("reference_set" not in args.keys()) or (args.get("reference_set") is None):
        print("Default reference files from unit_test/reference_files/ loaded.")
    ...
    ref_desc_grouped, ref_desc_dupl = calculate_descriptors.format_dataframe(ref_desc)
    ref_T5 = ref_desc_grouped[["input_compound_id", "descriptor_vector_id"]]
    ref_T6 = ref_desc_grouped[["descriptor_vector_id", "fp_feat", "fp_val", "fold_id"]]
